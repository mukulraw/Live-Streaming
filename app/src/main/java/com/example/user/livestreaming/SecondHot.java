...
public class SecondHot extends Fragment {
   ...
   LiveAdapter1 adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.secondhot , container , false);
    ...
    public class LiveAdapter1 extends RecyclerView.Adapter<LiveAdapter1.MyViewHolder> {
